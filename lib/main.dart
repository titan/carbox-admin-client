...
class _AppState extends State<AppWidget> {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      '/home': (BuildContext context) => new HomePage(title: '主页', store: store),
      '/signin': (BuildContext context) => new SignInPage(title: '用户登录', store: store),
      '/devices': (BuildContext context) => new DevicesPage(title: '设备管理', store: store),
      },
    );
  }
}
